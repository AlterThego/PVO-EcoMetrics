...
class FarmSuppliesExport extends Controller
{
    public function generateExcel()
    {
        ...
        $drawing->setWorksheet($sheet);
         ...
         $drawing->setOffsetX(90); // Reset X offset to align with the left of the cell
        ...
        $sheet->setCellValue('B7', 'Establishement Name');
        $sheet->setCellValue('C7', 'Year Established');
        $sheet->setCellValue('D7', 'Year Closed');
        ...
        foreach ($data as $item) {
            ...
            $sheet->setCellValue('B' . $row, $item->establishment_name);
            $sheet->setCellValue('C' . $row, $item->year_established);
            $sheet->setCellValue('D' . $row, $item->year_closed);
