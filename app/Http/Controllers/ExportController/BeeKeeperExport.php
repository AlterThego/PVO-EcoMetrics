...
class BeeKeeperExport extends Controller
{
    public function generateExcel()
    {
        ...
        $drawing->setWorksheet($sheet);
         ...
         $drawing->setOffsetX(15); // Reset X offset to align with the left of the cell
        ...
        $sheet->setCellValue('C7', 'Colonies');
        $sheet->setCellValue('D7', 'Bee Keepers');
        ...
        foreach ($data as $item) {
            ...
            $sheet->setCellValue('C' . $row, $item->colonies);
            $sheet->setCellValue('D' . $row, $item->bee_keepers);
