                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <form action="{{ route('health.yearly-disease.store') }}" method="post">
                        ...
                        <div class="grid gap-4 mb-4 sm:grid-cols-1">
                            <div>
                                <label for="common_disease_name"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Diseases</label>
                                <select name="common_disease_name" id="common_disease_name"
                        ...
                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                            ...
                            <div>
                                <label for="disease_count"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Disease Count</label>
